 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Fri Jan 15 17:20:25 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME lecture_codeur
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
#define SOURCEFILES           "__SFB__entry_0__SFB__"
...
extern void lecture_codeur_Outputs_wrapper(real_T *compteur,
			real_T *omega,
			const real_T *xD,
			const boolean_T *simu, const int_T p_width0);
extern void lecture_codeur_Update_wrapper(real_T *compteur,
			real_T *omega,
			real_T *xD,
			const boolean_T *simu, const int_T p_width0);
/*====================*
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const boolean_T *simu = (const boolean_T *) mxGetData(PARAM_DEF0(S));
    
    lecture_codeur_Outputs_wrapper(compteur, omega, xD, simu, p_width0);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    lecture_codeur_Update_wrapper(compteur, omega, xD, simu, p_width0);
